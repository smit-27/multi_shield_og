...
@REM echo.
@REM echo [2/2] Launching Frontends...
@REM echo Starting Banking System Frontend (Port 5173)...
@REM start cmd /k "cd dummy-banking-system\frontend && npm run dev"

@REM echo Starting Security Platform Frontend (Port 5174)...
@REM start cmd /k "cd security-platform\frontend && npm run dev"
